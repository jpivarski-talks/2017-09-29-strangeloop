...
By shrink-wrapping a language around our problem, we could add nice features:
\begin{itemize}
\item automatically vectorize objects
\item 100\% compile-time error checking with dependent types
\end{itemize}

\column{0.33\linewidth}
Since last year, other projects started adding functional programming to query languages:
\begin{itemize}
...
At the same time, we discovered that Femtocode's internal data representation is orders of magnitude faster than our current methods.
