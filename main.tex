...
\begin{frame}{Particle physics: the most industrial field in academia}
\vspace{0.15 cm}
\begin{columns}
...
\textcolor{darkblue}{The goals are academic:} to explore strange new phenomena and seek out new particles and new interactions.

\vspace{0.5 cm}
\textcolor{darkblue}{The scale is industrial:} billion dollar hardware, decadal timescales, millions of lines of code.
