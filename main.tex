...
\begin{frame}{Our software developed \only<1>{outside}\only<2->{\xcancel{outside} before} the big data ecosystem}
\vspace{0.5 cm}
\begin{uncoverenv}<3->
...
\begin{frame}{Particle physics data are not even stored in databases!}
