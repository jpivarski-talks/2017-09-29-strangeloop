...
%% \vspace{0.5 cm}
%% if we can provide a database-style server, the physicists would \\ have to use it for analysis queries, not bulk downloads.
...
%% \item<3-> The interface must allow for algorithms on objects.
%% \end{itemize}
%% \end{minipage}
%% \end{center}
%% \end{frame}
...
\vspace{0.5 cm}
\uncover<4->{\textcolor{darkblue}{The data representation is just Arrow; the code transformation can be automated.}}
\end{frame}
