...
\vspace{0.5 cm}
\uncover<2->{By ``database,'' I mean a shared system that can answer analysis questions directly, such as making histograms (aggregations) on a human timescale (subsecond).}

\vspace{0.5 cm}
\uncover<3->{But also perform large-scale processing and filtering \\ on data as {\it objects.}}
\end{center}
\end{minipage}
\end{center}
\end{frame}
